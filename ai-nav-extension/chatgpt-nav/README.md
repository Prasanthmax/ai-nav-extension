...
**Jump to any message in a long ChatGPT conversation — instantly.**

[![Works on ChatGPT](https://img.shields.io/badge/Works%20on-chatgpt.com-10a37f?style=flat-square)](https://chatgpt.com)
...
4. Click **Load unpacked** → select the `chatgpt-nav` folder
5. Visit [chatgpt.com](https://chatgpt.com) and open any conversation
